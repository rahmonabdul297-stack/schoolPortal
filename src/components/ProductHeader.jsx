  ...
  return (
    <div className="w-full bg-[#F9F8FB] shadow-2xl fixed z-30">
      ...
      <div className="flex items-center justify-between gap-3">
          ...
          <div className={AccDrop?"bg-white py-2 fixed right-20  top-20 border flex flex-col items-start capitalize":"hidden"}>

            <Link className="hover:bg-[#c0a742] hover:text-white w-full px-2">sign up new account</Link>
            <Link className="hover:bg-[#c0a742] hover:text-white w-full px-2">sign in to account</Link>
