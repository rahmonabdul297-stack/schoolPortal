    ...
    <div className=" py-24">
      <section className="container rounded-3xl lg:h-[500px] border flex flex-col lg:flex-row">
        <div className="bg-[#c0a742] text-black lg:w-[50%] h-full flex flex-col items-center justify-center p-10">
          ...
          <div className="mt-4 flex flex-col justify-between">
            ...
            <div className="flex items-center">
              <MdEmail />
              Email Address:<p>shirtarena@mail.com</p>
            </div>
          </div>
        </div>
        <div className="bg-[#000] text-[#c0a742] lg:w-[50%] h-full flex flex-col justify-center p-10">
          ...
          <div className="font-black text-xl lg:text-6xl overflow-hidden capitalize text-center">
            contact us
          </div>
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input
                type="email"
                placeholder=""
                className="outline-0 w-full p-2 rounded-lg border"
              />
            </div>
            <div>
              <label>message</label>
          ...
          <div className="w-full bg-[#c0a742] text-black p-2 text-center  rounded-lg capitalize">
            submit
          </div>
        </div>
      </section>
